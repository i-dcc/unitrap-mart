...
create table ikmc_unitrap_mart.TEMP0 as select a.region_start as gene_start,a.region_name as chromosome,a.external_name as marker_symbol,a.biotype,a.region_id as region_id_1020_key,a.seq_id as ensembl_gene_id,a.region_end as gene_end,a.region_strand as strand,a.refseq_id from ikmc_unitrapcore.gene as a;
...
create table ikmc_unitrap_mart.TEMP2 as select a.*,b.hit_db as assembly,b.start as unitrap_start,b.accession as unitrap_accession_id,b.unitrap_id as unitrap_id_1015_key,b.ambiguous,b.end as unitrap_end from ikmc_unitrap_mart.TEMP1 as a left join ikmc_unitrapcore.unitrap as b on a.region_id_1020_key=b.region_id;
...
create index I_14 on ikmc_unitrap_mart.TEMP2(gene_start);
create index I_15 on ikmc_unitrap_mart.TEMP2(gene_end);
create index I_16 on ikmc_unitrap_mart.TEMP2(unitrap_start);
